                        ...
                        <tbody id="categoryTableBody">
                            ...
                            <?php
                              ...
                              FROM 
                                ...
                                WHERE wstatus.link_status=4 AND tkt.reported_by=".$_SESSION['user_id'];
                              ...
                              FROM 
                                ...
                                WHERE wstatus.link_status=4 AND log.id =".$_SESSION['user_id'];
                              }
                              ...
                              FROM 
                                ...
                                LEFT JOIN contacts cnt ON cnt.company_id=cmp.company_id 
                                LEFT JOIN agent_login log ON log.contact_id=cnt.contact_id
                                WHERE tkt.contact_ids=(SELECT agent_login.contact_id FROM agent_login WHERE agent_login.id=".$_SESSION['user_id'].") AND wstatus.link_status=4 AND log.id =".$_SESSION['user_id'];
                              }
