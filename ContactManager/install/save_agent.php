...
if (!empty($_POST['id'])) {
    ...
    $updateAgentNotificationQuery = "UPDATE agent_notification SET email='$email', mobile_no = '$mobileNo', whatsapp_no = '$whatsappNo', smtp = '$smtp', email_pasword = '$emailPassword', port='$port' WHERE agent_id = $agentId";
