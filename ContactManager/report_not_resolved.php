                ...
                <table id="company_table" class="table table-bordered table-striped">
                        ...
                        <tbody id="categoryTableBody">
                            ...
                            <?php
                                ...
                                if($user_type == 1)
                                {
                                  $query = $query." WHERE wstatus.link_status != 1 AND tkt.assigned_to=".$user_id;
                                }
                                else
                                {
                                  $query = $query." WHERE wstatus.link_status != 1";
                                }
                                $result = $mysqli->query($query);
    ...
    $.ajax({
        ...
        success: function(response) {
          ...
          data.forEach(function (ticketData, index) {                                
              ...
              td = td + "<td>" + ticketData.CompanyName + "</td>";              
              td = td + "<td>" + ticketData.ProjectName + "</td>";              
              td = td + "<td title='" + ticketData.details + "'>" + ticketData.Title + "</td>";   

              td = td + "<td>" + ticketData.assign_by + "</td>";  
              td = td + "<td>" + ticketData.assign_to + "</td>";  
              td = td + "<td>" + ticketData.WorkStatus + "</td>";      
              td = td + "<td>" + ticketData.link_status + "</td>";      
              ...
              if(ticketData.link_status != "Close")
              {
