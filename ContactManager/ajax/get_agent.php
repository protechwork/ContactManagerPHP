...
if (!empty($_GET['id'])) {
    ...
    $query = "SELECT am.city, am.aadhar_no,am.pan_no, am.photo, am.name, am.difficulty_contact, am.address, an.mobile_no, an.whatsapp_no, an.smtp, an.port, an.email_pasword, an.email, al.user_id, al.password, al.is_admin, al.agent_type FROM agent_master am 
